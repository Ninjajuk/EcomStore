...
import BarChartComponents from "../Charts/BarChartComponets";
...
function AdminMainContent() {
  return (
    <AdminLayout>
      <div
        className=" md:w-full max-h-screen flex-grow bg-black  overflow-y-auto md:px-4 py-2"
      ...
      >
        <div className=" flex flex-col md:flex-row ">
          ...
          <div className=" w-full md:w-3/5">
            ...
            <div className=" h-2/5 px-2 py-2 bg-gray-200 mt-2 mb-2 rounded-md ">
          ...
          <div className="md:w-2/5 px-2">
            <div className="h-1/3 bg-yellow-200 p-2 mb-2 rounded-md shadow-md">
            ...
            <div className="h-1/3 bg-purple-200 p-2 mb-2 rounded-md shadow-md">
